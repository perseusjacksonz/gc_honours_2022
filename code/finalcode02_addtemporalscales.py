...
#Create a loop through every day
#This file would include all the pixels of the casestudy as well, which is ok. Just make sure to run the FINALCODE_ADDTEMPORALSCALES_CASESTUDYDAYS.py file afterward to overwrite the casestudy days
for file in range(len(dtf_modis_after15_fireseason)):
